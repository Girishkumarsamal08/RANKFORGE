      ...
      <main className="flex flex-1 items-center justify-center p-6">
        <div className="w-full max-w-md rounded-2xl border border-zinc-200 bg-white p-8 shadow-xl shadow-zinc-100">
          <div className="flex flex-col items-center text-center">
            ...
            <h2 className="mt-4 text-2xl font-bold tracking-tight text-zinc-900">Welcome Back</h2>
            <p className="mt-1.5 text-sm text-zinc-500">Sign in to your RANKFORGE account to study</p>
          </div>
